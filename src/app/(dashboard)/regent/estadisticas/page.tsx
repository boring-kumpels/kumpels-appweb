...
export const metadata: Metadata = {
  title: "Estadísticas - Pharmacy Regent",
  description:
    "Estadísticas médicas y análisis de rendimiento - Vista de regente farmacéutico",
};

export default async function RegentEstadisticasPage() {
